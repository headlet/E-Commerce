...
function SingleProduct() {
  ...
  return (
    <section className="flex flex-col items-center justify-center w-full p-4 gap-5">
      ...
      {/* CHANGED: Replaced lg:grid-cols-3 with lg:grid-cols-[2fr_2fr_1fr] */}
      <div className="w-full bg-white rounded-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_2fr_1fr] p-8 justify-center gap-6">
        ...
        <div className="flex flex-col gap-6 mt-14 p-4">
        ...
        {/* Third Section (Will now have less width seamlessly on LG) */}
        <div className="  flex flex-col gap-4 ">
          <div className=" flex flex-col gap-4 bg-gray-200 rounded-lg p-6">
            ...
            <div className="flex items-center justify-center bg-white rounded-lg p-2">
              ...
              <input
                ...
                name="quantity"
                value="1"
                className="text-center font-semibold focus:outline-none focus:border-white"
              />
              <button>
                <FaPlus />
              </button>
            ...
            <button className="bg-[#1ABA1A] p-3 rounded-lg">ADD TO CART</button>
          ...
          <div className="flex flex-col justify-center items-center gap-4 bg-gray-200 rounded-lg p-6">
               <p className="bg-black text-white p-2 rounded-lg">Quick Order 24/7</p>
               <h2 className="text-2xl font-bold">+01-49234823</h2>   
          </div>

          <h2 className="flex justify-center items-center gap-2"><FaTruck/> Ships from <span className="font-bold">NEPAL</span></h2>
        </div>
      </div>
    </section>
  );
