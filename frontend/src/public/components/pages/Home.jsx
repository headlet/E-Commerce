...
function Home() {
  return (
    <section className="flex flex-col items-center justify-center">
      <div className="w-full mx-auto flex flex-col md:flex-row justify-center items-start gap-3 mb-10 p-4">

        {/* LEFT CATEGORY */}
        <div className="w-full md:w-[22%] pr-0 lg:pr-4 flex gap-2 md:gap-0 sm:flex-col text-md p-2 md:p-9 lg:pt-9 overflow-x-auto lg:overflow-visible bg-white rounded-2xl">
        ...
        {/* CENTER SECTION */}
        <div className="flex flex-col justify-center items-center gap-3 w-full md:w-[47%]">
          ...
          >
            <div className="absolute inset-0 flex flex-col justify-center items-start p-6 md:p-9 text-white bg-black/30">
              <h2 className="text-xl md:text-2xl font-bold">Noise Cancelling</h2>
          ...
          <div className="flex flex-row justify-center items-center gap-4 w-full">
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-sm md:text-base w-44">
                  Sono Playgo 5 from <span className="text-[#1ABA1A]">$569</span>
                </h2>
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-sm md:text-base w-44">
                  Logitek Bluetooth <span className="text-[#FFC107]">Keyboard</span>
                </h2>
        ...
        {/* RIGHT SECTION */}
        <div className="flex flex-col justify-center items-center gap-4 w-full md:w-[30%]">
          ...
          >
            ...
            <div className="absolute right-0 z-10 text-white p-3">
              <h3 className="text-xl w-40 font-bold">Sport Water Resistance Watch</h3>
          ...
          >
            ...
            <div className="relative z-10 text-white p-5 w-35 space-y-3">
              <h3><span className="text-xl font-bold">OKODO </span>HERO 11+ BLACK</h3>
              <p>
